          ...
          <div className="dash-left">
            ...
            <div style={{background:C.card,border:`1px solid ${marketConviction?marketConviction.color+'50':C.border}`,borderRadius:10,padding:'16px 20px',marginBottom:12,boxShadow:C.shadow}}>
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:8}}>
                <div style={{fontSize:12,color:C.dim,letterSpacing:1,fontWeight:700,fontFamily:"'Inter',sans-serif",textTransform:'uppercase'}}>MARKET SENTIMENT <span style={{fontWeight:400,fontSize:10,letterSpacing:0,textTransform:'none',color:C.subtext}}>· based on price action</span></div>
                <button className="hv" onClick={()=>{ fetchPriceBar(); setNextRefresh(30) }}
