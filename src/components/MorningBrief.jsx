...
// ── Component ─────────────────────────────────────────────────────────────────
export default function MorningBrief({ getToken, theme, isAdmin }) {
  const C    = theme || {}
  ...
  return (
    <div style={{background:cardBg,border:`1px solid ${border}`,borderRadius:10,overflow:'hidden',fontFamily:'Inter,sans-serif'}}>
      ...
      {/* ── News ticker ────────────────────────────────────────────────────── */}
      {currentNews && (
        <div style={{padding:'6px 18px',background:dark?'#0a0f1a':'#f1f5f9',borderBottom:`1px solid ${border}`,display:'flex',alignItems:'center',gap:8,overflow:'hidden'}}>
