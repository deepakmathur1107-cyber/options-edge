...
// ── Clerk appearance ──────────────────────────────────────────────────────────
// Matches the Signal palette's dark theme (warm slate/amber). Clerk's
// appearance API takes static values, not live theme state, so this
// deliberately mirrors DARK_THEME from theme.js rather than trying to
// thread light/dark switching into the auth modal.
const clerkAppearance = {
  variables: {
    colorBackground:      '#1c1916',
    colorInputBackground: '#15120f',
    colorInputText:       '#f0ebe2',
    colorText:            '#f0ebe2',
    colorTextSecondary:   '#b8ad9c',
    colorPrimary:         '#e8a84e',
    colorDanger:          '#c2705a',
    borderRadius:         '8px',
