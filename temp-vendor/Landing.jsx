...
const FAQS = [
  ...
  { q:'Where does the market data come from?',  a:'Live options chain data via a professional-grade market data feed — real bid/ask, Greeks, open interest, and volume on every scan.' },
      ...
      <div className="hero-grid">
        <div>
          ...
          <p style={{ fontFamily:MONO, fontSize:12, color:C.dim, lineHeight:1.8, marginBottom:28 }}>
            Live market data · Real bid/ask · 6 hard-block filters · AI morning brief
          </p>
