    ...
    <div style={{background:C.bg,minHeight:'100vh',fontFamily:"'IBM Plex Mono',monospace",color:C.text,paddingBottom:80,transition:'background .25s, color .25s'}}>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        /* Consistent expand/collapse visual affordance for every <details> in
           the app — previously listStyle:'none' removed the browser's default
           triangle and replaced it with nothing, so "this is expandable" was
           communicated by text alone with no icon at all. */
        .expand-summary{display:flex;align-items:center;gap:9px;}
        .expand-summary::before{
          content:'';flex-shrink:0;width:7px;height:7px;
          border-right:2px solid ${C.orange};border-bottom:2px solid ${C.orange};
          transform:rotate(-45deg);transition:transform .18s ease;margin-left:1px;
        }
        details[open]>.expand-summary::before{transform:rotate(45deg);margin-top:-2px}
        .expand-summary .expand-hint{
          margin-left:auto;font-size:10px;color:${C.dim};font-weight:400;
